...
export const experiencesData = [
  {
    ...
    location: "Istanbul",
    description:
      "My six-month training at Acunmedya Akademi was more than just a technical education — it was a comprehensive journey where I discovered the dynamics of teamwork, project management, and digital production.Throughout this period, I received hands-on training in areas ranging from JavaScript and React to version control systems and user experience design. Working on projects based on real-world briefs allowed me to strengthen my frontend development skills while also improving my communication, content creation, and presentation abilities. Mentored by industry professionals, I gained valuable insights within a collaborative environment that closely mirrored real-world scenarios.The discipline and vision I acquired during this experience continue to fuel my passion for building and creating today.",
